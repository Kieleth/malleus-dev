...
| Executed checks | [structural contract](../research/ontology_driven_kg_realization/experiments/small_shop/correction/checks/structural-conformance.json), [source-mapping declaration](../research/ontology_driven_kg_realization/experiments/small_shop/correction/source-mapping-declaration.json), [executor](../research/ontology_driven_kg_realization/experiments/small_shop/correction/run.py) | The one check the policy requires and Core runs, the research-local source-mapping recompute Core does not vouch for, and the exact fixture entrypoint bytes. |
