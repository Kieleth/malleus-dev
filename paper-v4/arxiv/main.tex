...
\subsection{Calibration: the logistics shop fixture}
...
run-03 & Claude Sonnet~5 & skill, no brief & \multicolumn{6}{l}{in progress} \\
\bottomrule
\end{tabular}
\end{table}
