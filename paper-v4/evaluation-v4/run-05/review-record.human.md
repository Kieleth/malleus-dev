...
```json
{
  ...
  "ratification": {
    ...
    "completed_at": "2026-09-05T00:58:22Z",
    "notes": "Ratified as recorded. Decided by Luis in chat on 2026-09-05 after the overseer presented every responsiveness verdict, the support counts, the five PARTIAL rows and the three derivation-reach notes; recorded by the overseer session at their instruction."
  }
}
```
