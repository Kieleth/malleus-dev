...
```json
{
  ...
  "ratification": {
    ...
    "notes": "Ratified as recorded. Decided by Luis in chat on 2026-09-03; recorded by the overseer session at his instruction. All four queries returned zero rows; the cited blocks are the ones that answer the questions in prose."
  }
}
```
