...
```json
{
  ...
  "ratification": {
    ...
    "notes": "Ratified as recorded. Decided by Luis in chat on 2026-09-03; recorded by the overseer session at his instruction. The single CQ-04 row matches page:5:block:006 (saturation at ~0.7 GPa and 1250 C) and carries no mechanism or hypothesis marker."
  }
}
```
