"""The shop-01 ontology gate the parent runs between producer attempts.

The compiler sources come from the producer workspace and are checked against
shop-01's own frozen manifest. Refusals are written through unchanged: ``detail``
...
PROFILE_TARGET = "inputs/profile-state-version.json"
