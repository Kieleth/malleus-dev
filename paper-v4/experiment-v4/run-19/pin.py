"""Pin run-19 to one Core commit and write the manifest and the gate block.
...
Core-18 is carried the way run-18 carried it, at fixed commits, and it is not
...
run-18 are frozen and none of them is edited.

    .venv/bin/python paper-v4/experiment-v4/run-19/pin.py --commit <sha>
"""
...
def pin(commit_argument: str, reading: Path) -> dict[str, object]:
    ...
    # Carried from run-18, itself carried from run-08. The entry records what
    ...
    # Carried from run-18, where run-09 had it as the change under test. Its
    ...
    # Carried from run-18, where run-10 had it as the change under test. Its
    ...
    # Carried from run-18, where run-11 had it as the change under test. Its
    ...
    # Carried from run-18, where run-12 had it as the change under test. Its
    ...
    # Carried from run-18, itself carried from run-13, where it was the change
    ...
    # run-14, where it was the change under test. Its two byte comparisons, its enum
