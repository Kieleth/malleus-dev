    ...
    def test_acolyte_carries_the_nascent_project_playbook(self):
        ...
        required = (
            ...
            (
                ...
                "check accepts any of them the sentence writes as a word: "
                "whitespace between its characters is ignored, a digit, a "
                "punctuation mark, a space or an end of the sentence bounds "
                "it, and a form inside another word names nothing"
            ),
            (
                "Where the source inflects the form, \"velocity models\" for a "
                "subject named \"velocity model\", or the text layer glues it "
