...
|---|---|
| Replace handwritten Assent with declarative execution | [Authorization comparison](2026-09-08-authorization-conformance.md) adds neutral independent verdict expectations and records the shared Python calculator and narrower finite profile. This is not the hard cutover. Freeze the full claimed transition contract and prove old-path removal before promotion. |
